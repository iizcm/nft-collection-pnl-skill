...
cp -r web3/nft-collection-pnl ~/.hermes/skills/web3/nft-collection-pnl/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/nft-collection-pnl-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/nft-collection-pnl-skill.git ~/.hermes/skills/web3/nft-collection-pnl/
```
...
```text
skill_view(name="web3/nft-collection-pnl")
```
...
```text
Use the nft collection pnl skill to <describe your specific task here>
```
...
```text
Gunakan skill nft collection pnl untuk <deskripsikan tugas spesifik Anda di sini>
```
